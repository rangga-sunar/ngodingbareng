!(function (e, t) {
  ...
  return (function (e) {
    ...
    function (e, t, r) {
      ...
      var R,
        ...
        T =
          ...
          function (e, t) {
            ...
            for (
              var n = "data:" + t + ";base64,", i = 0, a = e.length;
              i < a;
              i += 3
            ) {
              var o = 255 & e[i],
        ...
        (this._onComObjOnMessage = function (e) {
          ...
          if (t.targetName === n.sourceName)
            if (t.stream) n._processStreamMessage(t);
              ...
              var s = i[o];
              delete i[o],
                "error" in t ? s.reject(O(t.error)) : s.resolve(t.data);
            } else {
              if (!(t.action in a))
      ...
      (F.prototype = {
          ...
          return new i.ReadableStream(
            {
              ...
              pull: function (e) {
                var t = k();
                return (
                  (a.streamControllers[o].pullCall = t),
                  a.postMessage({
                    sourceName: s,
                    targetName: l,
                    stream: "pull",
              ...
              cancel: function (e) {
                var t = k();
                return (
                  (a.streamControllers[o].cancelCall = t),
                  (a.streamControllers[o].isClosed = !0),
                  a.postMessage({
                    sourceName: s,
                    targetName: l,
                    stream: "cancel",
        ...
        _createStreamSink: function (e) {
          var t = this,
            ...
            u = {
              enqueue: function (e) {
                ...
                if (!this.isCancelled) {
                  ...
                  (this.desiredSize -= t),
                    n > 0 &&
                      this.desiredSize <= 0 &&
                      ((this.sinkCapability = k()),
                      (this.ready = this.sinkCapability.promise)),
                    l({ stream: "enqueue", chunk: e, transfers: r });
                }
              },
              close: function () {
                this.isCancelled ||
              ...
              error: function (e) {
                this.isCancelled ||
                  ((this.isCancelled = !0), l({ stream: "error", reason: e }));
              },
              sinkCapability: k(),
              onPull: null,
              onCancel: null,
        ...
        (t.removeNullCharacters = function (e) {
          return "string" != typeof e
            ? (s("The argument for removeNullCharacters must be a string."), e)
            : e.replace(y, "");
        }),
        (t.ReadableStream = i.ReadableStream),
        (t.setVerbosityLevel = function (e) {
          Number.isInteger(e) && (o = e);
        }),
    ...
    function (e, t, r) {
      ...
      var o = "noopener noreferrer nofollow",
            ...
            n(e, [
              {
                ...
                value: function (e, t) {
                  ...
                  var r = document.createElementNS(s, "svg:svg");
                  return (
        ...
        d = { NONE: 0, SELF: 1, BLANK: 2, PARENT: 3, TOP: 4 },
        f = ["", "_self", "_blank", "_parent", "_top"];
      var p = (function () {
          function e() {
            var t =
      ...
      (t.RenderingCancelledException = h),
        (t.addLinkAttributes = function (e) {
          ...
          if (
            ...
            var s = Object.values(d).includes(n) ? n : d.NONE;
            (e.target = f[s]), (e.rel = "string" == typeof a ? a : o);
          }
        }),
      ...
      (t.createResponseStatusError = function (e, t) {
        ...
        (t.validateRangeRequestCapabilities = function (e) {
          ...
          return Number.isInteger(s)
            ? ((o.suggestedLength = s),
              s <= 2 * i ? o : ((o.allowRangeRequests = !0), o))
            : o;
        }),
    ...
    function (e, t, r) {
      ...
      e.exports = function (e, t, r, p, m, v, g) {
        l(r, t, p);
        var _,
          b,
          y,
          ...
          P = !1,
          C = e.prototype,
          k = C[h] || C["@@iterator"] || (m && C[m]),
          R = k || A(m),
          x = m ? (w ? A("entries") : R) : void 0,
          T = ("Array" == t && C.entries) || k;
        if (
          (T &&
            (y = c(T.call(new e()))) !== Object.prototype &&
            y.next &&
            (u(y, S, !0), n || "function" == typeof y[h] || o(y, h, f)),
          w &&
            k &&
            "values" !== k.name &&
            ((P = !0),
    ...
    function (e, t, r) {
      ...
      for (
        ...
        var v,
          ...
          b = o[g],
          y = b && b.prototype;
        if (y && (y[c] || s(y, c, d), y[h] || s(y, h, g), (l[g] = d), _))
    ...
    function (e, t, r) {
      ...
      var n = Object.create(null),
        ...
        a = /Trident/.test(i),
        o = /\b(iPad|iPhone|iPod)(?=;)/.test(i),
        s = /CriOS/.test(i),
        l = /Safari\//.test(i) && !/(Chrome\/|Android\s)/.test(i);
      (a || s) && (n.disableCreateObjectURL = !0),
        (l || o) && ((n.disableRange = !0), (n.disableStream = !0));
      var u = Object.freeze(n);
    ...
    function (e, t, r) {
      ...
      if (r(25)()) {
        ...
        var d = r(130).PDFFetchStream;
        i.setPDFNetworkStreamFactory(function (e) {
          return new d(e);
        });
      } else {
        var f = r(131).PDFNetworkStream;
        i.setPDFNetworkStreamFactory(function (e) {
          return new f(e);
        });
      }
    ...
    function (e, t, r) {
      "use strict";
      r(63), (e.exports = r(5).String.includes);
    },
    function (e, t, r) {
      "use strict";
      var n = r(3),
        i = r(64);
      n(n.P + n.F * r(66)("includes"), "String", {
        includes: function (e) {
    ...
    function (e, t, r) {
      "use strict";
      r(68), (e.exports = r(5).Array.includes);
    },
    function (e, t, r) {
      "use strict";
      var n = r(3),
    ...
    function (e, t, r) {
      "use strict";
      r(73), (e.exports = r(5).Number.isNaN);
    },
    function (e, t, r) {
      "use strict";
      var n = r(3);
    ...
    function (e, t, r) {
      "use strict";
      r(75), (e.exports = r(5).Number.isInteger);
    },
    function (e, t, r) {
      "use strict";
      var n = r(3);
      n(n.S, "Number", { isInteger: r(76) });
    },
    function (e, t, r) {
      "use strict";
      var n = r(2),
    ...
    function (e, t, r) {
      "use strict";
      r(45), r(78), r(50), r(87), r(94), r(95), (e.exports = r(5).Promise);
    },
    function (e, t, r) {
      "use strict";
      var n = r(79)(!0);
    ...
    function (e, t, r) {
      ...
      e.exports = function () {
        ...
        if (l)
          ...
          new a(u).observe(d, { characterData: !0 }),
            (r = function () {
              d.data = h = !h;
            });
        }
    ...
    function (e, t, r) {
      "use strict";
      r(45), r(50), r(97), r(108), r(110), (e.exports = r(5).WeakMap);
    },
    function (e, t, r) {
      "use strict";
      var n,
        ...
        _ = (e.exports = r(104)("WeakMap", v, g, l, !0, !0));
      c(function () {
        return 7 != new _().set((Object.freeze || Object)(m), 7).get(m);
      }) &&
        (s((n = l.getConstructor(v, "WeakMap")).prototype, g),
        (o.NEED = !0),
    ...
    function (e, t, r) {
      ...
      e.exports =
        ...
        r(12)(function () {
          ...
          ? function (e, t) {
              for (
                var r = o(e), l = arguments.length, u = 1, c = i.f, h = a.f;
                l > u;
      ...
      e.exports = function (e, t, r, m, v, g) {
        ...
        if (
          ...
          R ||
            ...
            (A.constructor = b)),
            (k || x) && (w("delete"), w("has"), v && w("get")),
            (x || C) && w(y),
            g && A.clear && delete A.clear;
        } else
          (b = m.getConstructor(t, e, v, y)), o(b.prototype, r), (s.NEED = !0);
        return (
          f(b, e),
          (S[e] = b),
          i(i.G + i.W + i.F * (b != _), S),
          ...
          ("__proto__" in {}
            ? (function (e, t, n) {
                try {
                  (n = r(9)(
                    Function.call,
                    r(107).f(Object.prototype, "__proto__").set,
                    2
                  ))(e, []),
    ...
    function (e, t, r) {
      "use strict";
      r(113), (e.exports = r(5).Object.values);
    },
    function (e, t, r) {
      "use strict";
      var n = r(3),
    ...
    function (e, t, r) {
      ...
      e.exports = function (e) {
        return function (t) {
          for (var r, o = i(t), s = n(o), l = s.length, u = 0, c = []; l > u; )
            a.call(o, (r = s[u++])) && c.push(e ? [r, o[r]] : o[r]);
          return c;
        };
      };
    },
      ...
      !(function (e, t) {
        ...
        (function (e) {
          ...
          function (e, t, r) {
            ...
            (t.typeIsObject = function (e) {
              ...
              (t.PromiseInvokeOrPerformFallback = function (e, t, r, n, i) {
                ...
                try {
                  return Promise.resolve(s(l, e, r));
                } catch (e) {
                  return Promise.reject(e);
                }
              }),
          ...
          function (e, t, r) {
            ...
            function w(e, t) {
              var r = e._state;
              "writable" !== r ? (h("erroring" === r), C(e)) : P(e, t);
            }
            function P(e, t) {
              ...
              h(void 0 !== r, "controller must not be undefined"),
                ...
                (e._storedError = t);
              var n = e._writer;
              void 0 !== n && j(n, t), !1 === x(e) && !0 === r._started && C(e);
            }
            function C(e) {
          ...
          function (e, t, r) {
            ...
            var a = r(0),
              ...
              O = C.WritableStreamDefaultWriterRelease,
              I = C.WritableStreamDefaultWriterWrite,
              F = C.WritableStreamCloseQueuedOrInFlight,
              L = (function () {
                function e() {
                  var t =
                      arguments.length > 0 && void 0 !== arguments[0]
                    ...
                    },
                    {
                      ...
                      value: function (e) {
                        ...
                        return new Promise(function (r, c) {
                          var h, d, f;
                          if (
                            (v(t, o._closedPromise, function (t) {
                              !1 === i
                                ? g(
                                    function () {
                                      return T(e, t);
                              ...
                              : (function (e, t) {
                                  ...
                                  return (function (e, t) {
                                    ...
                                    if (e._queueTotalSize > 0) {
                                      if (!0 === ye(e, a)) {
                                        var l = _e(a);
                                        return Se(e), Promise.resolve(s(l, !1));
                                      }
                  ...
                  n(e, [
                    {
                      ...
                      value: function (e) {
                        ...
                        !(function (e, t) {
                          ...
                          b(e._pendingPullIntos.length > 0), Ce(e, t);
                    ...
                    },
                    {
                      ...
                      value: function (e) {
                        ...
                        !(function (e, t) {
                          ...
                          (r.buffer = t.buffer), Ce(e, t.byteLength);
                        })(this._associatedReadableByteStreamController, e);
                      },
                    },
                    {
            ...
            function Pe(e) {
              for (
                ...
                !0 === ye(e, t) && (ke(e), ge(e._controlledReadableStream, t));
              }
            }
            function Ce(e, t) {
              var r = e._pendingPullIntos[0],
          ...
          function (e, t, r) {
            ...
            var a = r(1).assert,
              o = r(0),
              s = o.InvokeOrNoop,
              l = o.PromiseInvokeOrPerformFallback,
              u = o.PromiseInvokeOrNoop,
              c = o.typeIsObject,
              h = r(4),
              d = h.ReadableStream,
            ...
            function y(e, t) {
              ...
              !0 === v(r) <= 0 && !1 === e._backpressure && C(e, !0);
            }
            function A(e) {
                    ...
                    },
                    {
                      ...
                      value: function (e) {
                        return (function (e, t) {
                          ...
                          return l(r, "transform", [t, n], k, [t, n]).then(
                            function () {
              ...
              I = (function () {
                function e() {
                  ...
                  (this._writable = new _(c, n)),
                    ...
                    C(this, v(this._readableController) <= 0);
                  var h = this,
    ...
    function (e, t, r) {
      ...
      var n,
        ...
        c = r(119),
        h = r(18),
        d = (n = h) && n.__esModule ? n : { default: n },
        f = r(59),
        p = r(121),
        m = r(123),
        v = r(124);
      ...
      "undefined" == typeof window
        ...
        "undefined" != typeof requirejs &&
          requirejs.toUrl &&
          (b = requirejs.toUrl("pdfjs-dist/build/pdf.worker.js"));
      var w,
        ...
        k = (function () {
          function e(e, t) {
            (this.length = e),
              ...
              (this._readyCapability = (0, o.createPromiseCapability)());
          }
          return (
            (e.prototype = {
        ...
        x = (function () {
          function e(e, t, r) {
            ...
            (this.pageIndex = e),
              (this.pageInfo = t),
              (this.transport = r),
              (this._stats = n ? new s.StatTimer() : s.DummyStatTimer),
              (this._pdfBug = n),
            ...
            (e.prototype = {
              ...
              getViewport: function (e) {
                var t =
                  ...
                  r =
                    ...
                    void 0 !== arguments[2] &&
                    arguments[2];
                return new o.PageViewport(this.view, e, t, 0, 0, r);
              },
              ...
              getOperatorList: function () {
                ...
                return (
                  t.opListReadCapability ||
                    ...
                    (t.opListReadCapability = (0, o.createPromiseCapability)()),
                    (t.renderTasks = []),
                ...
                return new Promise(function (e, r) {
                  ...
                  !(function t() {
                    n.read().then(function (r) {
                      ...
                      r.done
                        ? e(i)
                        : (o.Util.extendObj(i.styles, n.styles),
                          o.Util.appendToArray(i.items, n.items),
                          t());
                    }, r);
                  })();
                });
              ...
              _tryCleanup: function () {
                ...
                this.pendingCleanup &&
                  ...
                  (this.annotationsPromise = null),
                  e &&
                    this._stats instanceof s.StatTimer &&
                    (this._stats = new s.StatTimer()),
                  (this.pendingCleanup = !1));
              },
              ...
              get stats() {
                return this._stats instanceof s.StatTimer ? this._stats : null;
              },
            }),
            e
          );
                    ...
                    var n = new WeakMap(),
                      i = {
                        data: (function e(r) {
                          ...
                          var i, s;
                          if ((s = r.buffer) && (0, o.isArrayBuffer)(s)) {
                            var l = t && t.includes(s);
                            return (
                              (i =
                                r === s
                                  ? r
                          ...
                          r)) {
                            for (
                              var c, h = r;
                              !(c = Object.getOwnPropertyDescriptor(h, u));
        ...
        E = (function () {
          ...
          function a() {
            ...
            if (
              ...
              (this.verbosity = (0, o.isNum)(c)
                ? c
                : (0, o.getVerbosityLevel)()),
              (this._readyCapability = (0, o.createPromiseCapability)()),
              (this._port = null),
          ...
          return (
            (a.prototype = {
              ...
              _initializeFromPort: function (e) {
                (this._port = e),
                  (this._messageHandler = new o.MessageHandler(
                    "main",
                    "worker",
                    e
                  )),
              ...
              _initialize: function () {
                var e,
                  n,
                  i = this;
                if ("undefined" != typeof Worker && !_ && !r()) {
                  var a = t();
                  try {
                    (0, o.isSameOrigin)(window.location.href, a) ||
                      ((e = new URL(a, window.location).href),
                      (n = "importScripts('" + e + "');"),
                      (a = URL.createObjectURL(new Blob([n]))));
                    var s = new Worker(a),
                      l = new o.MessageHandler("main", "worker", s),
                      u = function () {
                    ...
                    s.addEventListener("error", c),
                      l.on("test", function (e) {
                        (s.removeEventListener("error", c), i.destroyed)
                          ? u()
                          ...
                          ? ((i._messageHandler = l),
                            ...
                            l.send("configure", { verbosity: i.verbosity }))
                          : (i._setupFakeWorker(), l.destroy(), s.terminate());
                      }),
                      l.on("ready", function (e) {
                        if ((s.removeEventListener("error", c), i.destroyed))
                          u();
                        else
                          try {
                            h();
                    ...
                    var h = function () {
                      ...
                      try {
                        ...
                        (0, o.info)("Cannot use postMessage transfers"),
                          (e[0] = 0),
                          l.send("test", e);
                      }
                    };
              ...
              _setupFakeWorker: function () {
                var i = this;
                _ || ((0, o.warn)("Setting up fake worker."), (_ = !0)),
                  (function () {
                      ...
                      : ((
                          ...
                          function (e) {
                            o.Util.loadScript(t(), function () {
                              e(window.pdfjsWorker.WorkerMessageHandler);
                            });
                          }
                        )(n.resolve),
                        n.promise);
                    ...
                    if (i.destroyed)
                      ...
                      i._port = n;
                      var a = "fake" + e++,
                        s = new o.MessageHandler(a + "_worker", a, n);
                      t.setup(s, n);
                      var l = new o.MessageHandler(a, a + "_worker", n);
        ...
        O = (function () {
          function e(e, t, r, n, i) {
            (this.messageHandler = e),
              ...
              (this.pageCache = []),
              (this.pagePromises = []),
              (this.downloadInfoCapability = (0, o.createPromiseCapability)()),
          ...
          return (
            (e.prototype = {
              destroy: function () {
                ...
                (this.destroyed = !0),
                  (this.destroyCapability = (0, o.createPromiseCapability)()),
              ...
              setupMessageHandler: function () {
                ...
                e.on(
                      ...
                      (t.onPull = function () {
                        r._fullReader
                          ...
                          .then(function (e) {
                            ...
                            e.done
                              ? t.close()
                              : ((0, o.assert)((0, o.isArrayBuffer)(r)),
                  ...
                  e.on(
                    ...
                    function (e) {
                      ...
                      if (
                        ...
                        this._passwordCapability.reject(
                          new o.PasswordException(e.message, e.code)
                        );
                  ...
                  e.on(
                    ...
                    function (e) {
                      this.loadingTask._capability.reject(
                        new o.InvalidPDFException(e.message)
                      );
                    },
                    this
                  ),
                  e.on(
                    ...
                    function (e) {
                      this.loadingTask._capability.reject(
                        new o.MissingPDFException(e.message)
                      );
                    },
                    this
                  ),
                  e.on(
                    ...
                    function (e) {
                      this.loadingTask._capability.reject(
                        new o.UnexpectedResponseException(e.message, e.status)
                      );
                    },
                    this
                  ),
                  e.on(
                    ...
                    function (e) {
                      this.loadingTask._capability.reject(
                        new o.UnknownErrorException(e.message, e.details)
                      );
                    },
                    this
                  ),
                        ...
                        if (!this.commonObjs.hasData(r))
                          switch (n) {
                            case "Font":
                              ...
                              if ("error" in i) {
                                var s = i.error;
                                (0, o.warn)("Error during font loading: " + s),
              ...
              getPage: function (e) {
                ...
                var n = this.messageHandler
                  ...
                  .then(function (e) {
                    ...
                    var n = new x(r, e, t, t._params.pdfBug);
              ...
              getMetadata: function () {
                ...
                return this.messageHandler
                  ...
                  .then(function (t) {
                    return {
                      info: t[0],
                      metadata: t[1] ? new p.Metadata(t[1]) : null,
        ...
        L = (function () {
          ...
          function t(e, t, r, n, i, a, s, l) {
            ...
            (this.callback = e),
              ...
              (this.cancelled = !1),
              (this.capability = (0, o.createPromiseCapability)()),
      ...
      (t.version = "2.0.489"),
        ...
        (t.getDocument = function (e) {
          ...
          else if ((0, o.isArrayBuffer)(e)) t = { data: e };
          ...
          var n = Object.create(null),
            i = null,
            l = null,
            c = s.DOMCMapReaderFactory;
          for (var h in t)
            if ("url" !== h || "undefined" == typeof window)
              if ("range" !== h)
                if ("worker" !== h)
                  if ("data" !== h || t[h] instanceof Uint8Array)
                    "CMapReaderFactory" !== h ? (n[h] = t[h]) : (c = t[h]);
                  else {
                    var d = t[h];
                    if ("string" == typeof d) n[h] = (0, o.stringToBytes)(d);
                    else if (
                      "object" !== (void 0 === d ? "undefined" : a(d)) ||
                      null === d ||
                      isNaN(d.length)
                    ) {
                      if (!(0, o.isArrayBuffer)(d))
                        throw new Error(
                          "Invalid PDF binary data: either typed array, string or array-like object is expected in the data property."
                        );
                      n[h] = new Uint8Array(d);
                    } else n[h] = new Uint8Array(d);
                  }
                else l = t[h];
              else i = t[h];
            else n[h] = new URL(t[h], window.location).href;
          (n.rangeChunkSize = n.rangeChunkSize || g),
            (n.ignoreErrors = !0 !== n.stopAtErrors),
            (n.pdfBug = !0 === n.pdfBug);
          var p = Object.values(o.NativeImageDecoding);
          if (
            ((void 0 !== n.nativeImageDecoderSupport &&
              p.includes(n.nativeImageDecoderSupport)) ||
              (n.nativeImageDecoderSupport = o.NativeImageDecoding.DECODE),
            ...
            "boolean" != typeof n.disableRange &&
              (n.disableRange = u.apiCompatibilityParams.disableRange || !1),
            "boolean" != typeof n.disableStream &&
              (n.disableStream = u.apiCompatibilityParams.disableStream || !1),
            "boolean" != typeof n.disableAutoFetch && (n.disableAutoFetch = !1),
            "boolean" != typeof n.disableCreateObjectURL &&
              (n.disableCreateObjectURL =
                u.apiCompatibilityParams.disableCreateObjectURL || !1),
            (0, o.setVerbosityLevel)(n.verbosity),
            !l)
          ) {
            var v = {
              ...
              _ = f.GlobalWorkerOptions.workerPort;
            _ ? ((v.port = _), (l = E.fromPort(v))) : (l = new E(v)),
              (r._worker = l);
          }
          var b = r.docId;
          return (
            l.promise
              .then(function () {
                ...
                return (function (e, t, r, n) {
                ...
                })(l, n, i, b).then(function (e) {
                  if (r.destroyed) throw new Error("Loading aborted");
                  var t = void 0;
                  i
                    ? (t = new m.PDFDataTransportStream(
                        {
                          length: n.length,
                  ...
                  var a = new o.MessageHandler(b, e, l.port);
                  a.postMessageTransfers = l.postMessageTransfers;
                  var s = new O(a, r, t, n, c);
                  (r._transport = s), a.send("Ready", null);
                });
              })
      ...
      Object.defineProperty(i.prototype, "loadTestFont", {
              ...
              complete: function () {
                for (
                  (0, n.assert)(
                    ...
                    r.end = Date.now();
                  t.requests.length > 0 && t.requests[0].end;
        ...
        (i.prototype.prepareFontLoadEvent = function (e, t, r) {
          ...
          for (o = 0, s = h.length - 3; o < s; o += 4)
            f = (f - 1482184792 + i(h, o)) | 0;
          o < h.length && (f = (f - 1482184792 + i(h + "XXX", o)) | 0),
        ...
        o = (function () {
          function e(e, t) {
            var r = t.isEvalSupported,
              ...
              o = t.fontRegistry,
              s = void 0 === o ? null : o;
            for (var l in ((this.compiledGlyphs = Object.create(null)), e))
              this[l] = e[l];
            (this.isEvalSupported = !1 !== n),
              (this.disableFontFace = !0 === a),
              (this.fontRegistry = s);
          }
          return (
            (e.prototype = {
              ...
              getPathGenerator: function (e, t) {
                if (!(t in this.compiledGlyphs)) {
                  var r,
                    n,
                    i,
                    o = e.get(this.loadedName + "_path_" + t);
                  if (this.isEvalSupported && a.value) {
                    var s,
                      l = "";
                    for (n = 0, i = o.length; n < i; n++)
                      (s = void 0 !== (r = o[n]).args ? r.args.join(",") : ""),
                        (l += "c." + r.cmd + "(" + s + ");\n");
                    this.compiledGlyphs[t] = new Function("c", "size", l);
                  } else
                    this.compiledGlyphs[t] = function (e, t) {
                      for (n = 0, i = o.length; n < i; n++)
                        "scale" === (r = o[n]).cmd && (r.args = [t, -t]),
        ...
        c = (function () {
            ...
            if ("undefined" != typeof ImageData && t instanceof ImageData)
              ...
              if (t.kind === n.ImageKind.GRAYSCALE_1BPP) {
                var b = g.byteLength,
                  ...
                  S = (h + 7) >> 3,
                  w = 4294967295,
                  P = o.value ? 4278190080 : 255;
                for (i = 0; i < p; i++) {
                  for (l = i < f ? a : d, r = 0, s = 0; s < l; s++) {
                    for (
                      var C = b - v,
                        k = 0,
                        R = C > S ? h : 8 * C - 7,
                ...
                for (s = 0, u = h * a * 4, i = 0; i < f; i++)
                  _.set(g.subarray(v, v + u)),
                    (v += u),
                    e.putImageData(m, 0, s),
                    (s += a);
                i < p &&
                  ((u = h * d * 4),
                  _.set(g.subarray(v, v + u)),
          ...
          function r(e, t) {
            for (
              ...
              for (var f = d < o ? a : i, p = 3, m = 0; m < f; m++)
          ...
          function m(e, t, r, n) {
            ...
            !(function (e, t, r, n, i, a, o) {
              ...
              s = "Luminosity" === i ? p : f;
              for (
                var m = Math.min(n, Math.ceil(1048576 / r)), v = 0;
                v < n;
                v += m
              ) {
          ...
          for (var y in ((e.prototype = {
            ...
            executeOperatorList: function (e, t, r, i) {
              ...
              for (
                ...
                if ((u = o[s]) !== n.OPS.dependency) this[u].apply(this, a[s]);
                else
                  for (var m = a[s], v = 0, g = m.length; v < g; v++) {
                    var _ = m[v],
                      b = "g" === _[0] && "_" === _[1] ? f : p;
                    if (!b.isResolved(_)) return b.get(_, r), s;
                  }
                if (++s === l) return s;
                if (c && ++d > 10) {
              ...
              for (
                ...
                switch (0 | e[s]) {
                  case n.OPS.rectangle:
                    ...
                    break;
                  case n.OPS.moveTo:
                    (a = t[l++]), (o = t[l++]), r.moveTo(a, o);
                    break;
                  case n.OPS.lineTo:
                    (a = t[l++]), (o = t[l++]), r.lineTo(a, o);
                    break;
                  case n.OPS.curveTo:
                    (a = t[l + 4]),
                      (o = t[l + 5]),
                      r.bezierCurveTo(t[l], t[l + 1], t[l + 2], t[l + 3], a, o),
                      (l += 6);
                    break;
                  case n.OPS.curveTo2:
                    r.bezierCurveTo(a, o, t[l], t[l + 1], t[l + 2], t[l + 3]),
                      (a = t[l + 2]),
                      (o = t[l + 3]),
                      (l += 4);
                    break;
                  case n.OPS.curveTo3:
                    (a = t[l + 2]),
                      (o = t[l + 3]),
                      r.bezierCurveTo(t[l], t[l + 1], a, o, a, o),
                      (l += 4);
                    break;
            ...
            showText: function (e) {
              ...
              if (0 !== i) {
                ...
                1 !== o && (a.scale(o, o), (b /= o)), (a.lineWidth = b);
                var S,
                  w = 0;
                for (S = 0; S < h; ++S) {
                  var P = e[S];
                  if ((0, n.isNum)(P)) w += (f * P * i) / 1e3;
                    ...
                    if (r.remeasure && M > 0) {
                      var D = ((1e3 * a.measureText(L).width) / i) * o;
                      if (M < D && this.isFontSubpixelAAEnabled) {
                        var N = M / D;
                        (I = !0), a.save(), a.scale(N, 1), (C /= N);
                      } else M !== D && (C += (((M - D) / 2e3) * i) / o);
                    }
                    (P.isInFont || r.missingFile) &&
                      (v && !j
                        ? a.fillText(L, C, k)
                        : (this.paintChar(L, C, k, g),
                          j &&
                            ((R = C + j.offset.x / o),
                            (x = k - j.offset.y / o),
                            this.paintChar(j.fontChar, R, x, g)))),
                      (w += M * m + F * u),
                      I && a.restore();
                  }
                }
            ...
            showType3Text: function (e) {
              var t,
                ...
                f = s.wordSpacing,
                p = s.textHScale * c,
                m = s.fontMatrix || n.FONT_IDENTITY_MATRIX,
                v = e.length;
              if (
            ...
            beginGroup: function (e) {
              ...
              var o = Math.floor(i[0]),
                s = Math.floor(i[1]),
                l = Math.max(Math.ceil(i[2]) - o, 1),
                u = Math.max(Math.ceil(i[3]) - s, 1),
                h = 1,
                d = 1;
            ...
            paintImageMaskXObject: function (e) {
              ...
              if (
                    ...
                    n <= 1e3 && i <= 1e3
                      ? (function (e) {
                          ...
                          if ((0 !== d[f] && ((l[n + r] = 4), ++v), v > 1e3))
                            return null;
                          var _ = new Int32Array([0, s, -1, 0, -s, 0, 0, 0, 1]),
                            b = [];
                          for (t = 0; v && t <= o; t++) {
                            for (var y = t * s, A = y + a; y < A && !l[y]; )
                              y++;
                            if (y !== A) {
                              var S,
                                w = [y % s, t],
                ...
                u.save(),
                  ...
                  (u.fillStyle = o ? a.getPattern(u, this) : a),
                  u.fillRect(0, 0, n, i),
                  u.restore(),
            ...
            paintImageMaskXObjectRepeat: function (e, t, n, i) {
              ...
              c.save(),
                ...
                (c.fillStyle = l ? s.getPattern(c, this) : s),
                c.fillRect(0, 0, a, o),
                c.restore();
              for (var h = this.ctx, d = 0, f = i.length; d < f; d += 2)
                h.save(),
                  ...
                  h.scale(1, -1),
                  h.drawImage(u.canvas, 0, 0, a, o, 0, -1, 1, 1),
                  h.restore();
            },
            ...
            paintImageXObjectRepeat: function (e, t, r, i) {
              ...
              if (a) {
                for (
                  var o = a.width, s = a.height, l = [], u = 0, c = i.length;
                  u < c;
                  u += 2
                )
                  l.push({
            ...
            paintInlineImageXObject: function (e) {
              ...
              for (
                ...
                c > 2 && m > 1 && (c /= m / (_ = Math.ceil(m / 2))),
                  ...
                  (p = (o = this.cachedCanvases.getCanvas(g, _, b))
        ...
        a = (function () {
          function e(e, t, r, n, i, a, o, s) {
            var l,
              ...
              d = 4 * e.width;
            u[r + 1] > u[n + 1] &&
              ((l = r), (r = n), (n = l), (l = a), (a = o), (o = l)),
              u[n + 1] > u[i + 1] &&
                ((l = n), (n = i), (i = l), (l = o), (o = s), (s = l)),
              u[r + 1] > u[n + 1] &&
                ((l = r), (r = n), (n = l), (l = a), (a = o), (o = l));
              ...
              case "lattice":
                ...
                for (i = 0; i < u; i++)
                  for (var h = i * l, d = 0; d < c; d++, h++)
                    e(t, n, o[h], o[h + 1], o[h + l], s[h], s[h + 1], s[h + l]),
                      e(
                        t,
                        n,
                        o[h + l + 1],
          ...
          return function (e, r, n, i, a, o, s, l) {
            var u,
              c,
              h,
              d,
            ...
            if (l.isEnabled)
              (u = l.drawFigures({
                ...
                (c = s.getCanvas("mesh", S, w, !1)).context.drawImage(u, 2, 2),
                (u = c.canvas);
            else {
              var P = (c = s.getCanvas("mesh", S, w, !1)).context,
                C = P.createImageData(g, _);
              if (o) {
                var k = C.data;
                for (h = 0, d = k.length; h < d; h += 4)
                  (k[h] = o[0]),
                    (k[h + 1] = o[1]),
                    (k[h + 2] = o[2]),
                    (k[h + 3] = 255);
              }
              for (h = 0; h < a.length; h++) t(C, a[h], A);
          ...
          return {
            ...
            getPattern: function (e, u, c) {
              ...
              if (c)
                ...
                ((h = n.Util.singularValueDecompose2dScale(u.baseTransform)), s)
              ) {
          ...
          (r.prototype = {
            createPatternCanvas: function (e) {
              ...
              (w.groupLevel = e.groupLevel),
                this.setFillAndStrokeStyleToContext(w, o, l),
            ...
            setFillAndStrokeStyleToContext: function (r, i, a) {
              ...
              switch (i) {
                case e:
                  var l = this.ctx;
                  (o.fillStyle = l.fillStyle),
                    (o.strokeStyle = l.strokeStyle),
      ...
      var o = (function () {
        function e(t) {
          !(function (e, t) {
            ...
            (t = this._repair(t));
          var r = new a.SimpleXMLParser().parseFromString(t);
              ...
              },
              {
                ...
                value: function (e, t) {
                  ...
                  for (
                    ...
                    if (c < 0) return null;
                    (o = e.substring(n, c)),
                      i.push({ name: l, value: this._resolveEntities(o) }),
                      (n = c + 1),
                      a();
                  }
                      ...
                      switch (e[++r]) {
                        ...
                        case "!":
                          if ("--" === e.substring(r + 1, r + 3)) {
                            ...
                            var l = e.substring(r + 8, n + (s ? 1 : 0));
                            this.onDoctype(l), (r = n + (s ? 2 : 1));
                          }
                          break;
                        default:
                          ...
                          if (
                            ...
                            return void this.onError(o.UnterminatedElement);
                          this.onBeginElement(u.name, u.attributes, c),
                            (r += u.parsed + (c ? 2 : 1));
                      }
                    } else {
                      for (; r < e.length && "<" !== e[r]; ) r++;
                      var h = e.substring(t, r);
            ...
            i(t, [
              {
                ...
                value: function (e) {
                  if (
                    ...
                    return { documentElement: n(this._currentFragment, 1)[0] };
                },
              },
              {
                key: "onResolveEntity",
            ...
            (r.prototype = {
              ...
              read: function () {
                if (this._queuedChunk) {
                  ...
                  return (
                    (this._queuedChunk = null),
                    Promise.resolve({ value: e, done: !1 })
                  );
                }
                if (this._done)
                  return Promise.resolve({ value: void 0, done: !0 });
      ...
      var s = (function () {
        ...
        function n(e, n, a) {
          ...
          if ((e._textDivs.push(s), (o = n.str), !t.test(o)))
            return (l.isWhitespace = !0), void e._textDivProperties.set(s, l);
          var u = i.Util.transform(e._viewport.transform, n.transform),
            c = Math.atan2(u[1], u[0]),
            h = a[n.fontName];
          h.vertical && (c += Math.PI / 2);
          var d,
            f,
            p = Math.sqrt(u[2] * u[2] + u[3] * u[3]),
            m = p;
          if (
            (h.ascent
              ? (m = h.ascent * m)
              : h.descent && (m = (1 + h.descent) * m),
            0 === c
              ? ((d = u[4]), (f = u[5] - m))
              : ((d = u[4] + m * Math.sin(c)), (f = u[5] - m * Math.cos(c))),
            (r[1] = d),
            (r[3] = f),
            (r[5] = p),
            (r[7] = h.fontFamily),
            ...
            n.str.length > 1 &&
              (h.vertical
                ? (l.canvasWidth = n.height * e._viewport.scale)
                : (l.canvasWidth = n.width * e._viewport.scale)),
            ...
            var _,
              b,
              y = (h.vertical ? n.height : n.width) * e._viewport.scale,
              A = p;
            0 !== c
              ? ((_ = [v, g, -g, v, d, f]),
                (b = i.Util.getAxialAlignedBoundingBox([0, 0, y, A], _)))
              : (b = [d, f, d + y, f + A]),
              e._bounds.push({
                left: b[0],
                top: b[1],
        ...
        function s(e) {
          for (
            ...
            if (0 !== s.angle) {
              ...
              (s.paddingLeft = v(m, 32, 16) / g),
                (s.paddingTop = v(m, 48, 16) / g),
                (s.paddingRight = v(m, 0, 16) / g),
                (s.paddingBottom = v(m, 16, 16) / g),
          ...
          (u.prototype = {
            ...
            _render: function (e) {
              ...
              if (
                ...
                this._processItems(s, l), r.resolve();
              } else {
                ...
                (this._reader = this._textContentStream.getReader()),
                  (function e() {
                    t._reader.read().then(function (a) {
                      ...
                      a.done
                        ? r.resolve()
                        : (i.Util.extendObj(n, o.styles),
                          t._processItems(o.items, n),
                          e());
                    }, r.reject);
                  })();
              }
    ...
    function (e, t, r) {
      ...
      var l,
        u = { fontStyle: "normal", fontWeight: "normal", fillColor: "#000000" },
        c = (function () {
          for (
          ...
          function c(r, n, a, o) {
            ...
            return (
              P.set(e, C),
              l("IHDR", A, P, (C += e.length)),
              l("IDATA", S, P, (C += t + A.length)),
              (C += t + S.length),
              l("IEND", new Uint8Array(0), P, C),
        ...
        return (
          (r.prototype = {
            ...
            constructPath: function (t, r) {
              ...
              for (var s = [], l = t.length, u = 0, c = 0; u < l; u++)
                switch (0 | t[u]) {
            ...
            paintInlineImageXObject: function (t, r) {
              ...
              l.setAttributeNS(n, "xlink:href", o),
            ...
            n(e, [
              {
                ...
                value: function () {
                  ...
                  return this._readCapability.promise.then(function () {
                    ...
                    (e._loaded += t.length),
                      e.onProgress && e.onProgress({ loaded: e._loaded });
                    var r = new Uint8Array(t).buffer;
                    return Promise.resolve({ value: r, done: !1 });
                  });
                },
          ...
          function t(e, r, n) {
            ...
            return (
              ...
              i._setReadableStream(
                u.createReadStream(a, { start: r, end: n - 1 })
              ),
              i
            );
          }
    ...
    function (e, t, r) {
      ...
      t.getFilenameFromContentDispositionHeader = function (e) {
        ...
        function l(e) {
          return t && /[\x80-\xff]/.test(e) ? s("utf-8", e) : e;
        }
        function u(e) {
          if ('"' === e.charAt(0)) {
      ...
      var l = (function () {
        ...
        u = (function () {
          function e(t) {
            ...
            var c = n.url;
            fetch(c, s(this._headers, this._withCredentials))
              .then(function (e) {
                ...
                value: function () {
                  ...
                  return this._headersCapability.promise.then(function () {
                    return e._reader.read().then(function (t) {
                      var r = t.value,
                        n = t.done;
                      if (n) return Promise.resolve({ value: r, done: n });
        ...
        c = (function () {
          function e(t, r, n) {
            ...
            var f = u.url;
            fetch(f, s(this._headers, this._withCredentials)).then(function (
              e
            ) {
              if (!(0, a.validateResponseStatus)(e.status))
    ...
    function (e, t, r) {
      ...
      var c = (function () {
        try {
          ...
          return (
            e.open("GET", s.default.location.href),
