...
var Main = (function () {
  ...
  var runContainerHeight = function () {
    ...
    if (
      mainContainer.outerHeight() < mainNavigation.outerHeight() &&
    ...
    if ($windowWidth < 768) {
      mainNavigation.css(
        "min-height",
        $windowHeight - $("body > .navbar").outerHeight()
      );
    }
  };
    ...
    if ($(".todo-actions").length) {
      $(".todo-actions").click(function () {
        if (
          ...
          $(this).find("i").hasClass("icon-check-empty")
        ) {
  ...
  var runNavigationMenu = function () {
    ...
    $(".main-navigation-menu > li a").bind("click", function () {
      if (
        $(this).parent().children("ul").hasClass("sub-menu") &&
        (!$("body").hasClass("navigation-small") ||
          $windowWidth < 767 ||
          !$(this).parent().parent().hasClass("main-navigation-menu"))
      ) {
        if (!$(this).parent().hasClass("open")) {
          ...
          $(this)
            ...
            .children("li.open")
            .not($(this).parent())
            .not($(".main-navigation-menu > li.active"))
            .removeClass("open")
            .children("ul")
            .slideUp(200);
          $(this)
  ...
  var runCustomCheck = function () {
    if ($('input[type="checkbox"]').length || $('input[type="radio"]').length) {
      ...
      $(
        'input[type="checkbox"].flat-teal, input[type="radio"].flat-teal'
      ).iCheck({
  ...
  var runSearchInput = function () {
    ...
    search_input
      .attr("data-default", $(search_input).outerWidth())
      .focus(function () {
        $(this).animate(
          {
            width: 200,
  ...
  var setColorScheme = function () {
    $(".icons-color a").bind("click", function () {
      ...
      $("#skin_color").attr(
        "href",
        "assets/css/theme_" + $(this).attr("id") + ".css"
      );
    });
  };
  ...
  var setLayoutStyle = function () {
    $('select[name="layout"]').change(function () {
      ...
      else $("body").removeClass("layout-boxed");
    });
  };
  var setHeaderStyle = function () {
    $('select[name="header"]').change(function () {
      ...
      else $("body").removeClass("header-default");
    });
  };
  var setFooterStyle = function () {
    $('select[name="footer"]').change(function () {
      ...
      else $("body").removeClass("footer-fixed");
    });
  };
  ...
  var runActivateLess = function () {
    ...
    if ($("#skin_color").attr("rel") == "stylesheet") {
      $("#skin_color")
        ...
        .attr("href", "assets/less/styles.less");
  ...
  var runCustomSetting = function () {
    if ($.cookie("clip-setting")) {
      ...
      if (loadSetting.layoutBoxed) {
        $("body").addClass("layout-boxed");
        $('#style_selector select[name="layout"]')
          .find('option[value="boxed"]')
          .attr("selected", "true");
      }
      if (loadSetting.headerDefault) {
        $("body").addClass("header-default");
        $('#style_selector select[name="header"]')
          .find('option[value="default"]')
          .attr("selected", "true");
      }
      if (!loadSetting.footerDefault) {
        $("body").addClass("footer-fixed");
        $('#style_selector select[name="footer"]')
          .find('option[value="fixed"]')
          .attr("selected", "true");
      }
      if ($("#style_selector").length) {
        if (loadSetting.useLess) {
          $(".color-base")
            .val(loadSetting.baseColor)
            .next(".dropdown")
            .find("i")
            .css("background-color", loadSetting.baseColor);
          $(".color-text")
            .val(loadSetting.textColor)
            .next(".dropdown")
            .find("i")
            .css("background-color", loadSetting.textColor);
          $(".color-badge")
            .val(loadSetting.badgeColor)
            .next(".dropdown")
            .find("i")
            .css("background-color", loadSetting.badgeColor);
          runActivateLess();
        } else {
          $(".color-base")
            .val("#FFFFFF")
